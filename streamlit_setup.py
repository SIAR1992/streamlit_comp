...
st.text("Vælg kapaciteter/størrelser i sliders og omkostningen for det enkelte anlæg vil komme op. Scrol igennem og fyldt ud til investeringsloftet er nået. "
...
selected = option_menu(None,
                       ["Konkurrence", "Flere forudsætninger"],
                       icons=["sliders", "graph-up-arrow"],
...
if selected == "Flere forudsætninger":
    fredag_str = "2023-10-27"
    fredag_dato = datetime.strptime(fredag_str, "%Y-%m-%d")
